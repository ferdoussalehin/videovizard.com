...
if (isset($_POST['ajax_action']) && $_POST['ajax_action'] === 'preview_voice') {
    ...
    // Get sample text from hdb_voices using lang_code (e.g. 'en', 'hi')
    // with safe fallbacks if table missing or row not found
    $sample_text = "Hi there! This is a quick sample so you can hear how this voice sounds before you choose.";
    // Convert language name to lang_code for the DB lookup
    $lang_code_map = [
    ...
    // Try lang_code-specific row first
    ...
    vv_log("preview_voice | voice=$openai_voice lang=$language lc=$lc text=" . substr($sample_text, 0, 60));
