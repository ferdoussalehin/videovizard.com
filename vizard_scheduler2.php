        ...
        case 'post_now_instagram': {
            ...
            if ($platform === 'facebook') {
                ...
                $tq = mysqli_query($conn,
                    "SELECT platform, access_token, channel_id, channel_name
                     ...
                     WHERE admin_id=$admin_id AND platform LIKE 'facebook_page_%' AND token_expiry > NOW()");
            ...
            if ($platform === 'facebook') {
                ...
                if (!empty($res['id'])) {
                    ...
                    mysqli_query($conn,"UPDATE hdb_podcasts SET instagram_status='posted',ig_post_id='$ig_post_id',ig_posted_at=NOW(),ig_error=NULL,updated_at=NOW() WHERE id=$podcast_id");
                    maybe_mark_all_posted($conn, $podcast_id, $admin_id);
...
$platform_oauth_urls = [
    ...
    'instagram' => 'meta/ig_connect_vizard.php',
