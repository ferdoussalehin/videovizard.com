...
.option-card.card-promo::before   { background: linear-gradient(90deg, #6366f1, #06b6d4); }
.option-card.card-realestate::before { background: linear-gradient(90deg, #0f2a44, #5fd1ff); }
...
.tag-realestate { background: #e0f2fe; color: #075985; }
...
.option-card.card-promo:hover .option-cta-arrow  { background: #6366f1; }
.option-card.card-promo  .option-cta-text  { color: #4338ca; }
.option-card.card-promo  .option-cta-arrow { background: #e0e7ff; color: #4338ca; }
.tag-tools { background: #fdf2f8; color: #be185d; }
.tag-promo { background: #e0e7ff; color: #4338ca; }
.option-card.card-product  .option-cta-arrow { background: #d1fae5; color: #065f46; }
.option-card.card-realestate:hover .option-cta-arrow { background: #0891b2; }
.option-card.card-realestate .option-cta-text { color: #0891b2; }
.option-card.card-realestate .option-cta-arrow { background: #e0f2fe; color: #075985; }
...
.card-promo    .credit-cost { background: #eef2ff; border-color: #c7d2fe; }
.card-promo    .credit-amount { color: #4338ca; }
.card-product  .credit-amount { color: #065f46; }
.card-realestate .credit-cost { background: #f0f9ff; border-color: #bae6fd; }
.card-realestate .credit-amount { color: #075985; }
...
.options-grid .option-card:nth-child(5) { animation-delay: .28s; }
.options-grid .option-card:nth-child(6) { animation-delay: .34s; }
</style>
</head>
<body>
    ...
    <div class="wiz-card-body">
      ...
      <div class="options-grid">
        ...
        <a class="option-card card-story" href="vizard_scriptgen_1.php">
          ...
          <div class="credit-cost">
            ...
            <span class="credit-text">
              <span class="credit-amount">20 credits / 30 sec</span>
        ...
        <a class="option-card card-business" href="vizard_scriptgen_2.php">
          <span class="option-icon">🏢</span>
          <div class="option-title">Cinematic Promotion Videos</div>
          ...
          <div class="credit-cost">
            <span class="credit-coin">💳</span>
            <span class="credit-text">
              <span class="credit-amount">Up to 120 credits / 30 sec</span>
              <span class="credit-sub">6 scenes × 5 sec — cinematic AI visuals included</span>
            </span>
          </div>
        ...
        <!-- ── Option 3: Fashion & Apparel Try-On ────────────── -->
        <a class="option-card card-product" href="vizard_scriptgen_tryon.php">
          <span class="option-icon">👗</span>
          <div class="option-title">Fashion &amp; Apparel Try-On</div>
          <span class="option-tag tag-product">✦ Apparel · Model Required</span>

          <div class="option-desc">
            Put your clothing on an AI model with virtual try-on — built for apparel brands that need a model wearing the garment.
          </div>

          <div class="credit-cost">
            <span class="credit-coin">💳</span>
            <span class="credit-text">
              <span class="credit-amount">120+ credits / 30 sec</span>
              <span class="credit-sub">Garment try-on + themed model scenes</span>
            </span>
          </div>

          <div class="good-for">
            👗 Great for clothing, boutique fashion &amp; apparel brands needing a model
          </div>

          <div class="option-cta">
            <span class="option-cta-text">Start Try-On Video →</span>
            <span class="option-cta-arrow">›</span>
          </div>
        </a>


        <!-- ── Option 4: Real Estate Staging ───────────────── -->
        <a class="option-card card-realestate" href="vizard_scriptgen_staging.php">
          <span class="option-icon">🏠</span>
          <div class="option-title">Real Estate Staging</div>
          <span class="option-tag tag-realestate">✦ Property Listings</span>

          <div class="option-desc">
            Virtually stage empty or cluttered rooms and turn the listing into a polished walkthrough video — built for realtors.
          </div>

          <div class="credit-cost">
            <span class="credit-coin">💳</span>
            <span class="credit-text">
              <span class="credit-amount">50+ credits / listing</span>
              <span class="credit-sub">Static slideshow, or AI motion video at 20cr/room</span>
            </span>
          </div>

          <div class="good-for">
            🏠 Great for realtors, property listings, virtual staging &amp; walkthrough videos
          </div>

          <div class="option-cta">
            <span class="option-cta-text">Start Staging →</span>
            <span class="option-cta-arrow">›</span>
          </div>
        </a>


        <!-- ── Option 5: Product Promotional Videos ─────────── -->
        <a class="option-card card-promo" href="vizard_scriptgen_products.php">
          <span class="option-icon">🎬</span>
          <div class="option-title">Product Promotional Videos</div>
          <span class="option-tag tag-promo">✦ Promo &amp; Advertising</span>

          <div class="option-desc">
            Showcase jewellery, food, boutique items and ecommerce products with punchy promotional visuals — no model required.
          </div>

          <div class="credit-cost">
            <span class="credit-coin">💳</span>
            <span class="credit-text">
              <span class="credit-amount">100+ credits / 30 sec</span>
              <span class="credit-sub">Ad-style scenes &amp; promotional pacing</span>
            </span>
          </div>

          <div class="good-for">
            🛍 Great for restaurants, jewellery, ecommerce, product launches &amp; showcase reels
          </div>

          <div class="option-cta">
            <span class="option-cta-text">Start Promo Video →</span>
            <span class="option-cta-arrow">›</span>
          </div>
        </a>


        <!-- ── Option 6: AI Generation Tools ────────────────── -->
