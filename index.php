...
<head>
  ...
  <title> VideoVizard by IT Top Talent Inc — Launch a Month of Content in Minutes</title>
...
<div id="gateway">
  ...
  <div class="gw-topleft" style="display:flex;align-items:center;gap:8px;">
    <img src="/videovizard.com/images/logo.png" alt="VideoVizard Logo" class="gw-logo-img" style="height:36px;width:auto;"><span class="gw-logo-fixed"> VideoVizard <span></span> by IT Top Talent Inc</span>
  </div>
...
<nav id="navbar">
  <a href="#" class="nav-logo">
    ...
    <span class="logo-v"> VideoVizard </span><span class="logo-v2"> by IT Top Talent Inc</span>
...
<footer>
  <div class="footer-grid">
    <div>
      ...
      <div style="font-size:16px;color:#64748b;margin-top:-8px;margin-bottom:10px;font-weight:500;">by IT Top Talent Inc</div>
      ...
      <p class="footer-desc" style="display: none;">AI-powered social media video creation and scheduling. From one idea to a full month of content — in minutes.</p>
    </div>
  ...
  <div class="footer-bottom">
    <div>© 2025 IT Top Talent Inc by IT Top Talent Inc. All rights reserved.</div>
    <div style="display:flex;gap:20px;align-items:center;">
      <a href="https://videovizard.com/privacy.php" style="color:#94a3b8;text-decoration:none;font-size:13px;transition:.2s;" onmouseover="this.style.color='#0284c7'" onmouseout="this.style.color='#94a3b8'">Privacy Policy</a>
      <a href="https://videovizard.com/terms.php" style="color:#94a3b8;text-decoration:none;font-size:13px;transition:.2s;" onmouseover="this.style.color='#0284c7'" onmouseout="this.style.color='#94a3b8'">Terms &amp; Conditions</a>
    </div>
...
<!-- AI Chatbot by SaaS Platform -->
<!-- AI Chatbot by SaaS Platform -->
<script>
  window.CHATBOT_CONFIG = {
    botId: "bec87c9a-7bc3-4089-810e-f287f9938b04",
    welcomeMessage: "Hi there! 👋 How can I help you today?"
  };
</script>
<script src="https://chat-bot-ruddy-one.vercel.app/api/embed" async></script>
</body>
</html>
