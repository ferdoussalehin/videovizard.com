...
function renderBusinessBar() {
    ...
    ['business-bar-pills','ideas-business-pills','camp-business-pills'].forEach(function(id) {
...
function renderSettingsBar() {
    ...
    ['settings-bar-pills','ideas-video-pills','camp-video-pills'].forEach(function(id) {
        var el = document.getElementById(id);
        if (el) el.innerHTML = html;
    });
}
