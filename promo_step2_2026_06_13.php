...
if ($action === 'save_ai_scene_image') {
    ...
    $prompt_e = mysqli_real_escape_string($conn, $sp['image_prompt'] ?? $sp['video_prompt'] ?? $video_prompt);
    ...
    $pod_duration = max(5, min(60, (int)($_POST['duration'] ?? 5)));
    ...
    mysqli_query($conn, "INSERT INTO hdb_video_gen_que
        ...
        VALUES
        ($podcast_id, $scene_id, '$prompt_e', '$folder_e', 'video', '$fn_e',
